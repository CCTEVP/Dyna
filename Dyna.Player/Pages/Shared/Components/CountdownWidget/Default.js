...
function setupCountdown( widget, targetDate) {
    ...
    const cardWidgets = {
        days: widget.querySelector("[data-name='days'] div[id^='card-widget-']"), 
        hours: widget.querySelector("[data-name='hours'] div[id^='card-widget-']"),
        minutes: widget.querySelector("[data-name='minutes'] div[id^='card-widget-']"),
        seconds: widget.querySelector("[data-name='seconds'] div[id^='card-widget-']"),
    };
